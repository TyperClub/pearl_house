...
- + base_algorithm : save some sort algorithm  or others(such like LRU). I have no idea at this moment. 
- + base_structure : save some basic structure、 safe structure in threads.
- + memorandum : save some daily work code and debug experience in system design.
- +
